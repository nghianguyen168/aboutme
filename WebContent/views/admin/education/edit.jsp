                    ...
                    <div class="panel-body">
                		...
                		%>
                              <%
                                	...
                                	String timeto="";
                                	String description="";
                                	if(request.getAttribute("edu")!=null){
                                		Education edu = (Education)request.getAttribute("edu");
                                		id=edu.getId();
                                		name=edu.getName();
                                		timefrom=StringUtil.DaoChuoi(edu.getTimefrom())+"-01";
                                		timeto=StringUtil.DaoChuoi(edu.getTimeto())+"-01";
                                		description=edu.getDescription();
                                		
                                	}
                                	
                                %>
                                <form role="form" action="<%=request.getContextPath() %>/admin/edu/edit?id=<%=id %>" method="post"  id="form">
