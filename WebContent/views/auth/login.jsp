			...
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
				 ...
				 <%
                		...
                		%>
				<form class="login100-form validate-form p-b-33 p-t-5" action="<%=request.getContextPath()%>/auth/login" method="POST">
					<%
						String userN="";
						String pass="";
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" value="<%=pass %>" type="password" name="pass" placeholder="Mật khẩu">
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
